...
public class IpadDishController {
        ...
        try {
            ...
            if (category_id != null && !category_id.isEmpty()) {
                dishes = dishes.stream()
                        .filter(d -> category_id.equals(d.getCategoryId()))
                        .collect(Collectors.toList());
            }
            ...
            List<Map<String, Object>> result = dishes.stream().map(dish -> {
                ...
                map.put("category_id", dish.getCategoryId());
                ...
                map.put("cooking_method", dish.getCookingMethod());
    ...
    public Result<Map<String, Object>> getDishDetail(
        ...
        try {
            ...
            data.put("category_id", dish.getCategoryId());
            data.put("sale_price", dish.getSalePrice());
            data.put("cost_price", dish.getCostPrice());
            data.put("spicy_level", dish.getSpicyLevel());
            data.put("cooking_method", dish.getCookingMethod());
            data.put("taste", dish.getTaste());
            data.put("main_ingredients", dish.getMainIngredients());
            data.put("image_url", dish.getImageUrl());
            data.put("is_active", dish.getIsActive());
            data.put("remark", dish.getRemark());
