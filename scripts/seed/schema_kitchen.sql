...
CREATE TABLE IF NOT EXISTS goods_receipt (
    ...
    store_id BIGINT NOT NULL DEFAULT 1,
    request_id BIGINT,
    supplier_id INT COMMENT '供应商ID(对齐 supplier_master.supplier_id INT)',
...
CREATE TABLE IF NOT EXISTS unit_conversion (
    ...
    to_unit VARCHAR(20),
    conversion_rate DECIMAL(10,4) COMMENT '正向比率(from_unit → to_unit)',
    reverse_rate DECIMAL(10,4) COMMENT '反向比率(to_unit → from_unit)',
    category VARCHAR(50) COMMENT '类别:重量/容量/数量',
    description VARCHAR(255) COMMENT '描述(如:千克转克)',
    ingredient_id VARCHAR(50),
    status VARCHAR(20) DEFAULT 'active',
    notes VARCHAR(500),
    create_time DATETIME DEFAULT CURRENT_TIMESTAMP,
