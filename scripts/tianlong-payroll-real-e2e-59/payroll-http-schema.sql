-- ============================================================================
-- TL-RC-PAYROLL-HTTP-R2-59：工资 HTTP 闭环独立 schema 建表
-- 用途：由 run-http-e2e.sh 应用到「本任务新建的唯一 schema tlpay59_http_<时间戳>」。
-- 约束：仅 CREATE TABLE / INSERT，绝不 DELETE / DROP / TRUNCATE。
-- ============================================================================
...
-- month_salary -> payroll_payout_record 复合外键
