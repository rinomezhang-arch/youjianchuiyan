...
public class Overtime {
    ...
    public Double getSalaryMultiple() {
        return this.salaryMultiple;
    }

    public Double getOvertimeBonus() {
        return this.overtimeBonus;
    }
    ...
    public void setSalaryMultiple(Double salaryMultiple) {
