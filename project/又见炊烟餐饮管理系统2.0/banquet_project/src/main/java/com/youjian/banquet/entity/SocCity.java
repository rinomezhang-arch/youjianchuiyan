...
public class SocCity {
    ...
    @Column(name = "per_pension_rate", precision = 10, scale = 3)
    private BigDecimal perPensionRate;

    @Column(name = "com_pension_rate", precision = 10, scale = 3)
    private BigDecimal comPensionRate;

    @Column(name = "per_medical_rate", precision = 10, scale = 3)
    private BigDecimal perMedicalRate;

    @Column(name = "com_medical_rate", precision = 10, scale = 3)
    private BigDecimal comMedicalRate;

    @Column(name = "per_unemployment_rate", precision = 10, scale = 3)
    private BigDecimal perUnemploymentRate;

    @Column(name = "com_unemployment_rate", precision = 10, scale = 3)
    private BigDecimal comUnemploymentRate;

    @Column(name = "com_maternity_rate", precision = 10, scale = 3)
