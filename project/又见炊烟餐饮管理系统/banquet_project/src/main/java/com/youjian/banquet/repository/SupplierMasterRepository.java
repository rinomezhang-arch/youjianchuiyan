...
extends JpaRepository<SupplierMaster, Long>,
JpaSpecificationExecutor<SupplierMaster> {
    ...
    public Optional<SupplierMaster> findBySupplierIdAndStoreId(Long var1, Long var2);
    ...
    public void deleteBySupplierIdAndStoreId(Long var1, Long var2);
}
