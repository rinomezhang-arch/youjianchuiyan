...
public class BanquetTable {
    @Id
    @GeneratedValue(strategy=GenerationType.IDENTITY)
    @Column(name="table_id")
    private Integer tableId;
    // 安全修复 N3：storeId 类型从 String 改为 Long，与数据库 bigint 和 TableMaster 对齐
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BanquetTable)) {
            return false;
        }
        BanquetTable other = (BanquetTable)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof BanquetTable;
    }
