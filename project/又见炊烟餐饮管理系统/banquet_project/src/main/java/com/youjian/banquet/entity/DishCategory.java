 ...
 *  com.youjian.banquet.entity.DishCategory
...
public class DishCategory {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DishCategory)) {
            return false;
        }
        DishCategory other = (DishCategory)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DishCategory;
    }
    ...
    public String toString() {
        return "DishCategory(id=" + this.getId() + ", categoryName=" + this.getCategoryName() + ", categoryCode=" + this.getCategoryCode() + ", description=" + this.getDescription() + ", sortOrder=" + this.getSortOrder() + ", isActive=" + this.getIsActive() + ", createdAt=" + String.valueOf(this.getCreatedAt()) + ", updatedAt=" + String.valueOf(this.getUpdatedAt()) + ")";
    }

    public DishCategory() {
    }

    public DishCategory(Integer id, String categoryName, String categoryCode, String description, Integer sortOrder, Integer isActive, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.categoryName = categoryName;
        this.categoryCode = categoryCode;
        this.description = description;
