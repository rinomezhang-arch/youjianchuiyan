...
VALUES
  (1, 'E021', '王志强', 'M', '13856789012', '342601198503120015', '厨师长', 12, '后厨部-炒锅组', '2020-03-15', 'active', 'staff', 8500.00, 'e10adc3949ba59abbe56e057f20f883e', NOW(), NOW()),
  (1, 'E022', '刘美玲', 'F', '13912345678', '342601199203051234', '前厅经理', 5, '前厅部-散客组', '2019-08-20', 'active', 'staff', 7800.00, 'e10adc3949ba59abbe56e057f20f883e', NOW(), NOW()),
  (2, 'E023', '陈大壮', 'M', '13789012345', '342601198806121234', '采购员', 15, '采购部', '2021-05-10', 'active', 'staff', 6200.00, 'e10adc3949ba59abbe56e057f20f883e', NOW(), NOW()),
  (1, 'E024', '赵晓燕', 'F', '13567890123', '342601199507231234', '收银员', 18, '财务部', '2022-01-08', 'active', 'staff', 5500.00, 'e10adc3949ba59abbe56e057f20f883e', NOW(), NOW()),
  (1, 'E025', '孙立军', 'M', '13634567890', '342601198911301234', '传菜主管', 13, '后厨部-传菜组', '2021-09-22', 'active', 'staff', 5800.00, 'e10adc3949ba59abbe56e057f20f883e', NOW(), NOW());

-- =====================================================================
-- PART 3: 录入 15 个真实客户(15 条,全部 IGNORE)
-- =====================================================================
INSERT IGNORE INTO customer_master
  (customer_id, store_id, customer_name, customer_phone, gender, id_card, member_level, total_amount, booking_count, last_visit, address, birthday, status, source, created_at, updated_at)
VALUES
...
INSERT IGNORE INTO member_point_log
  (customer_id, change_type, change_points, balance_after, reason, related_type, related_id, operator_id, operator_name, created_at)
SELECT customer_id, 'income', 100, 100, '消费积分', 'booking', 0, 1, '张婧', DATE_SUB(NOW(), INTERVAL FLOOR(1 + RAND() * 90) DAY)
