...
const allModulePages = [
  ...
  // 总经办
  { name: '总经办', sub: 'GM Office', path: '/dashboard/gm-office', module: 'gmoffice', icon: 'gmoffice' },
  { name: '审批中心', sub: 'Approval', path: '/dashboard/approval-center', module: 'gmoffice', icon: 'approval' },
  { name: '营收看板', sub: 'Revenue', path: '/dashboard/revenue', module: 'front', icon: 'revenue' },
  { name: '卫生巡检', sub: 'Hygiene', path: '/dashboard/hygiene', module: 'engineering', icon: 'hygiene' },
  { name: '损耗报废', sub: 'Waste', path: '/dashboard/waste', module: 'supply', icon: 'waste' },
  { name: '票据税务', sub: 'Tax', path: '/dashboard/tax', module: 'finance', icon: 'tax' },
]
...
const activeModule = computed(() => {
  ...
  const map = {
    ...
    '/dashboard/safety': 'engineering', '/dashboard/hygiene': 'engineering',
    '/dashboard/gm-office': 'gmoffice', '/dashboard/approval-center': 'gmoffice',
    '/dashboard/revenue': 'front', '/dashboard/waste': 'supply', '/dashboard/tax': 'finance',
  }
  return map[p] || null
})
...
const iconMap = {
  ...
  // 总经办 - 皇冠/决策
  gmoffice: '<path d="M12 2L9 9l-7 2 5 5-1 7 6-3 6 3-1-7 5-5-7-2z"/>',
  // 审批中心 - 印章/审批
  approval: '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>',
  // 营收看板 - 增长图表
  revenue: '<path d="M18 20V10"/><path d="M12 20V4"/><path d="M6 20v-6"/>',
  // 卫生巡检 - 盾牌带勾
  hygiene: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/>',
  // 损耗报废 - 垃圾桶
  waste: '<path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/>',
  // 票据税务 - 文件带百分比
  tax: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><circle cx="8" cy="13" r="2"/><path d="M16 13h-2.5a1.5 1.5 0 0 1 0-3H16"/><path d="M8 17h8"/>',
}
...
.chat-panel-header {
  ...
  padding: 14px 16px;
  border-bottom: 1px solid var(--color-border);
  background: linear-gradient(135deg, #2D4A3E, #1D3A2E);
}
