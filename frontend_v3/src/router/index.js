...
const routes = [
  { path: '/', name: 'Welcome', component: Welcome, meta: { title: '又见炊烟' } },
  { path: '/login', name: 'Login', component: Login, meta: { title: '登录' } },
  { path: '/store-select', redirect: '/' },
  { path: '/table-select', redirect: '/' },
  { path: '/ipad-menu', name: 'IpadMenu', component: () => import('@/views/dashboard/IpadMenu.vue'), meta: { title: '点菜' } },
  {
    path: '/dashboard',
    name: 'Dashboard',
    component: Dashboard,
    ...
    children: [
      ...
      { path: 'ipad', name: 'DashboardIpad', component: () => import('@/views/dashboard/IpadMenu.vue'), meta: { requiresAuth: true, title: 'iPad点菜' } },
      ...
      { path: 'approval-center', name: 'ApprovalCenter', component: () => import('@/views/dashboard/ApprovalCenter.vue'), meta: { requiresAuth: true, title: '审批中心' } },
      { path: 'revenue', name: 'Revenue', component: () => import('@/views/dashboard/Revenue.vue'), meta: { requiresAuth: true, title: '营收看板' } },
      { path: 'hygiene', name: 'Hygiene', component: () => import('@/views/dashboard/Hygiene.vue'), meta: { requiresAuth: true, title: '卫生巡检' } },
      { path: 'waste', name: 'Waste', component: () => import('@/views/dashboard/Waste.vue'), meta: { requiresAuth: true, title: '损耗报废' } },
      { path: 'tax', name: 'Tax', component: () => import('@/views/dashboard/Tax.vue'), meta: { requiresAuth: true, title: '票据税务' } }
    ]
  }
]
