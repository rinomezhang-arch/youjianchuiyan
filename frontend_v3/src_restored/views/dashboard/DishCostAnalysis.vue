<template>
  <div class="cost-page">
    ...
    >
      ...
      <el-table-column label="售价 · Price" width="110" align="right">
        <template #default="{ row }">
...
const stats = computed(() => {
  ...
  return [
    { label: '菜品总数 · Total', value: total, cls: 'st-total' },
    { label: '平均成本率 · Avg Cost%', value: avgCostRate.toFixed(1) + '%', cls: 'st-avg' },
    { label: '高成本(>30%) · High', value: highCost, cls: 'st-high' },
    { label: '低成本(<20%) · Low', value: lowCost, cls: 'st-low' },
  ]
})
