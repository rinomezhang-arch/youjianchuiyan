CREATE TABLE IF NOT EXISTS ipad_device_binding (
  ...
  CONSTRAINT fk_ipad_device_store FOREIGN KEY (store_id) REFERENCES store_info(store_id),
  CONSTRAINT fk_ipad_device_staff FOREIGN KEY (staff_id) REFERENCES staff_master(staff_id)
