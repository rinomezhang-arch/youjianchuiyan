...
const routes = [
  ...
  { path: '/store-select', name: 'StoreSelect', component: StoreSelect, meta: { title: '选择门店' } },
  {
    ...
    children: [
      ...
      { path: 'banquet-notices', name: 'BanquetNotices', component: () => import('@/views/dashboard/BanquetNotice.vue'), meta: { requiresAuth: true, title: '宴会通知单', permission: 'banquet:notice:view' } },
      ...
      { path: 'menu-festive', name: 'MenuFestive', component: () => import('@/views/dashboard/SetMenu.vue'), meta: { requiresAuth: true, title: '节日菜单' } },
      ...
      { path: 'floor-project', name: 'FloorProject', component: () => import('@/views/dashboard/Engineering.vue'), meta: { requiresAuth: true, title: '楼面工程' } },
      ...
      { path: 'art-design', name: 'ArtDesign', component: () => import('@/views/dashboard/Decoration.vue'), meta: { requiresAuth: true, title: '美工与装饰' } },
      { path: 'table-layout', name: 'TableLayout', component: () => import('@/views/dashboard/TableBoard.vue'), meta: { requiresAuth: true, title: '桌台布局' } },
      { path: 'production', name: 'Production', component: () => import('@/views/dashboard/Kitchen.vue'), meta: { requiresAuth: true, title: '出品' } },
      ...
      { path: 'category-sort', name: 'CategorySort', component: () => import('@/views/dashboard/MenuManager.vue'), meta: { requiresAuth: true, title: '分类排序' } },
      { path: 'menu-sort', name: 'MenuSort', component: () => import('@/views/dashboard/MenuManager.vue'), meta: { requiresAuth: true, title: '菜单排序' } },
      // 套餐管理
      ...
      { path: 'pricing', redirect: '/dashboard/pricing-manage' },
      ...
      { path: 'sold-out', redirect: '/dashboard/soldout-control' },
      { path: 'packages', redirect: '/dashboard/set-menu' },
      { path: 'maintenance', redirect: '/dashboard/floor-project' },
